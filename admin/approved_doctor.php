       ...
       <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">Approved Doctors </h3>
            ...
            <div class="row">
              ...
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Approved Doctors</h4>
                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                       ...
                       <?php
          $seq=1;
          $qry1="SELECT * FROM tbl_login WHERE l_status='2' AND l_role='3'";
         ...
         ?>
          <tr>
            ...
            <td><a href="?approve=<?php echo $result1['l_id'];?>" onclick="return confirm('Sure to Delete?');" class="btn btn-danger">Delete</a></td>
          </tr>
          <?php
            $seq++;
            }
            if(isset($_GET['approve']))
             ...
             // $sql="DELETE FROM tbl_news WHERE news_id=".$_GET['del']."";
              $sql="UPDATE tbl_login SET l_status='0' WHERE l_id=".$_GET['approve']."";
